...
_T_MAX = 0.0359  # 20 gauge is 0.912mm, or 0.0359 inches
_W_MAX = 3+1/8
_L_MAX = 9
PART = 'TP 3-1/8 in. x 9 in. 20-Gauge Galvanized Tie Plate (Model # TP39)'
...
class Card:
    ...
    def build(self, doc: App.Document, prefix: str):
        ...
        panel.Length = App.Units.Quantity(l, 'in')
        panel.Width = App.Units.Quantity(w, 'in')
