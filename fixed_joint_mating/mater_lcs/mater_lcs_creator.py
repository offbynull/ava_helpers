...
def run(doc: App.Document, name: str = MATER_LCS_IDENTIFIER) -> App.DocumentObject:
    ...
    lcs.addProperty(
        'App::PropertyString',
        MATER_LCS_IDENTIFIER,
        MATER_LCS_IDENTIFIER,
        'The presence of this property is what identifies a mater LCS vs other LCSes. The value for this property is ' \
        + 'unused.'
    )
    lcs.setEditorMode(MATER_LCS_IDENTIFIER, 1)
    setattr(lcs, MATER_LCS_IDENTIFIER, '')
